export declare class TObject {
    ...
    **/
    ...
    private triggerEvent(type, target?, ...a);
}
export declare class TCollectionItem extends TObject {
    __ownerCollection: TCollection<TCollectionItem>;
    OwnerCollection: TCollection<TCollectionItem>;
    constructor();
}
...
export declare class TCollection<T> extends collections.Set<T> {
    locked: boolean;
    /**
    ...
    */
    EndUpdate(): void;
    refresh(): void;
    FindItemByID(ID: string): T;
}
export declare class TList<T> extends collections.LinkedList<T> {
    locked: boolean;
    /**
    * Signals the end of an update operation.
    * Call EndUpdate after completing an operation that was preceded by a call to the BeginUpdate method.
